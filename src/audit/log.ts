 ...
 * Audit records.
 *
 * Every record is namespaced by tenant and principal and includes the
 * connection, backend, catalog checksum, registry revision, operation,
 * outcome, and duration. Records never contain credentials; serialization
 * runs through the redactor before any output.
 */
